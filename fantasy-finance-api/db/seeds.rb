...
#
# Portfolio.create(user_id: 1, league_id: l["id"], current_balance: l["start_balance"])
# Portfolio.create(user_id: 2, league_id: l["id"], current_balance: l["start_balance"])
# Portfolio.create(user_id: 3, league_id: l["id"], current_balance: l["start_balance"])
# Portfolio.create(user_id: 4, league_id: l["id"], current_balance: l["start_balance"])
